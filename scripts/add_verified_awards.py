...
ADDITIONS = [
    ("都灵之马", "Csak a szél", "本斯·弗利高夫", "Bence Fliegauf", "评审团大奖银熊奖", "Jury Grand Prix - Silver Bear"),
...
def apply(path):
    ...
    for film_zh, film_en, director_zh, director_en, award_zh, award_en in ADDITIONS:
        ...
        if key in existing:
            continue
        rows.append({
            "festival": "Berlin", "festivalZh": "柏林", "year": 2012,
            "section": "Competition", "status": "winner",
            "filmZh": film_zh, "filmEn": film_en,
            "directorZh": director_zh, "directorEn": director_en,
            "awardZh": award_zh, "awardEn": award_en,
            "official": OFFICIAL, "imdbId": "", "doubanUrl": "",
            "trailerUrl": "", "technical": {}, "checkedAt": CHECKED_AT,
        })
