...
OFFICIAL = "https://www.berlinale.de/en/archive/awards-juries/awards.html/y=2022/o=desc/p=1/rp=40"
...
ADDITIONS = [
    ...
    ("拉比耶·库尔纳兹大战小布什", "Rabiye Kurnaz vs. George W. Bush", "安德里亚斯·德里森", "Andreas Dresen", "最佳主角银熊奖（Meltem Kaptan）", "Silver Bear for Best Leading Performance"),
    ("娜娜", "Before, Now & Then", "卡米拉·安迪妮", "Kamila Andini", "最佳配角银熊奖（Laura Basuki）", "Silver Bear for Best Supporting Performance"),
    ("拉比耶·库尔纳兹大战小布什", "Rabiye Kurnaz vs. George W. Bush", "安德里亚斯·德里森", "Andreas Dresen", "最佳编剧银熊奖（Laila Stieler）", "Silver Bear for Best Screenplay"),
    ("一切都会好的", "Everything Will Be Ok", "潘礼德", "Rithy Panh", "杰出艺术贡献银熊奖（Rithy Panh、Sarit Mang）", "Silver Bear for Outstanding Artistic Contribution"),
]
